        ...
        <Fade duration={500}>
          <div className="container my-5">
            <Alert variant="success">
              ...
              <h4 className="text-center">
                Front end practice daily is consist of the front end challanges{" "}
                <br /> Questions and problems are asked on the most popular
          ...
          <div className="container my-5">
            <h2 className="text-center">
              <a href="https://www.450dsa.com">Front end practice daily </a> is your personal
            ...
            <h4 className="text-center my-5">
              This is the clone Project of 450DSA.com by 
              <a
